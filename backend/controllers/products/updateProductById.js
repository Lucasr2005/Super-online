...
export async function updateProductById(req, res) {
    ...
    try {
        const result = await pool.query("UPDATE products SET name=$1, category_id=$2, brand=$3, price=$4, stock=$5, img_name=$6, sub_category=$7 WHERE id=$8 RETURNING *", [name, category_id, brand, price, stock, img_name, sub_category, id])
