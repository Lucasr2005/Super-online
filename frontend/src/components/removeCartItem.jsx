...
export function RemoveCartItem({ productId, display }) {
  ...
  return (
    ...
    >
      <div className="bg-white py-10 w-full mx-5 rounded-lg lg:max-w-md">
        <h1 className="text-sm font-semibold text-center lg:text-base">
          Deseas eliminar el producto del carrito?
        </h1>
        <div className="flex justify-center gap-5 mt-5">
          <button
            className=" text-black py-2 px-4 rounded-md cursor-pointer hover:underline"
            onClick={() => display(false)}
          >
            Cancelar
          </button>
